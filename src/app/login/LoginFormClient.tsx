    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
          ...
          <div className="mb-6">
            {lastLogin === 'apple' && (
              <p className="text-sm font-semibold text-gray-600 mb-2 text-center">You last signed in with Apple</p>
            )}
            <SocialAuthButtons
              mode="login"
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            {lastLogin === 'email' && (
              <p className="text-sm font-semibold text-gray-600 mb-2 text-center">You last signed in with email</p>
            )}
            <div>
              <label
                htmlFor="email"
