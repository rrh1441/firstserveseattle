      ...
      <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-lg">
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600">
            Sign up to start your <span className="font-semibold">{plan}</span> subscription
          </p>
        </div>
        ...
        <button
          ...
          className="mb-4 w-full rounded-md bg-green-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
        >
